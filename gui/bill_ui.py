...
"}")
        ...
        self.ds_hd_tb.setGeometry(QtCore.QRect(20, 90, 921, 521))
        font = QtGui.QFont()
        ...
        self.ds_hd_tb.setEditTriggers(QtWidgets.QAbstractItemView.AnyKeyPressed|QtWidgets.QAbstractItemView.DoubleClicked|QtWidgets.QAbstractItemView.EditKeyPressed|QtWidgets.QAbstractItemView.SelectedClicked)
...
"border-radius: 20px;")
        ...
        self.tim_hd_tbx.setGeometry(QtCore.QRect(730, 40, 171, 41))
        font = QtGui.QFont()
        font.setFamily("Noto Sans")
        font.setPointSize(10)
...
"}")
        ...
        self.tim_hd_btn.setGeometry(QtCore.QRect(900, 40, 41, 41))
...
"}")
        ...
        self.layoutWidget_6.setGeometry(QtCore.QRect(290, 626, 401, 71))
